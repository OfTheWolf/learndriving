      ...
      <div className="bg-gray-50 min-h-screen py-10">
        <div className="container mx-auto px-6 lg:px-12 max-w-4xl bg-white shadow-md rounded-lg p-8">
          ...
          <p className="text-gray-500 mb-6 text-center">
            Effective Date: <span className="font-semibold">June 17, 2025</span>
          </p>
          ...
          <section className="mb-6">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Log Data</h2>
            <p className="text-gray-600">
              ...
              configuration of the app, the time and date of your use of the
          ...
          <section className="mb-6">
            ...
            <p className="text-gray-600 mt-4 font-semibold">uguboz@gmail.com</p>
          </section>
        </div>
      </div>
    );
